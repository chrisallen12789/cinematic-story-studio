...
const forbiddenExtensions = new Map([
  ...
  [".m4b", "generated-audio"],
  [".mp3", "generated-audio"],
  [".npy", "model-or-voice-data"],
  [".npz", "model-or-voice-data"],
  [".ogg", "generated-audio"],
  [".onnx", "model-or-voice-data"],
  [".p12", "credential-file"],
  [".pdf", "private-source-document"],
  [".pem", "credential-file"],
  [".pfx", "credential-file"],
  [".pt", "model-or-voice-data"],
  [".pth", "model-or-voice-data"],
  [".safetensors", "model-or-voice-data"],
